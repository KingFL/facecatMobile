<template>
  <div class="mpvue-picker">
    ...
    <div class="mpvue-picker-content " :class="{'mpvue-picker-view-show':showPicker}">
      ...
      <!-- 二级联动 -->
      <picker-view indicator-style="height: 80upx;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChangeMul" v-if="mode==='multiLinkageSelector' && deepLength===2">
        <block>
          <picker-view-column>
      ...
      <!-- 三级联动 -->
      <picker-view indicator-style="height: 80upx;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChangeMul" v-if="mode==='multiLinkageSelector' && deepLength===3">
        <block>
          <picker-view-column>
